...
Note: the Key variable that connects the data sets is Brewery_id in Beer.csv and  Brew_ID in Brewery.csv. Will need to rename varibles to have matching column names in order to merge. 
